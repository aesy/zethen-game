...
//
// describe("Circle", () => {
//   const circle = new Circle({ x: 3, y: 5 }, 4);
//
//   describe("#center", () => {
...
//       expect(
//         circle.containsRect(new Rect(circle.center, { width: 2, height: 2 }))
//       ).toEqual(true);
//     });
//
//     it("should return false if the given rect is outside", () => {
//       expect(
//         circle.containsRect(new Rect({ x: 10, y: 10 }, { width: 2, height: 2 }))
//       ).toEqual(false);
//     });
//
//     it("should return false if the given rect is overlapping", () => {
//       expect(
//         circle.containsRect(new Rect(circle.center, { width: 2, height: 5 }))
//       ).toEqual(false);
//     });
//
...
//       expect(circle.containsCircle(new Circle(circle.center, 2))).toEqual(true);
//     });
//
//     it("should return false if the given circle is outside", () => {
//       expect(circle.containsCircle(new Circle({ x: 20, y: 25 }, 2))).toEqual(
//         false
//       );
//       expect(circle.containsCircle(new Circle({ x: -10, y: -10 }, 3))).toEqual(
//         false
//       );
//     });
//
//     it("should return false if the given circle is overlapping", () => {
//       expect(circle.containsCircle(new Circle({ x: -2, y: 5 }, 2))).toEqual(
//         false
//       );
//       expect(circle.containsCircle(new Circle({ x: -2, y: 2 }, 5))).toEqual(
//         false
//       );
//     });
//
//     it("should return false when given circle is surrounding", () => {
//       expect(circle.containsCircle(new Circle(circle.center, 15))).toEqual(
//         false
//       );
//     });
//
...
//     it("should return true if the given rect is inside", () => {
//       expect(
//         circle.overlapsRect(new Rect(circle.center, { width: 2, height: 2 }))
//       ).toEqual(true);
//     });
//
//     it("should return false if the given rect is outside", () => {
//       expect(
//         circle.overlapsRect(new Rect({ x: 10, y: 10 }, { width: 2, height: 2 }))
//       ).toEqual(false);
//     });
//
//     it("should return true if the given rect is overlapping", () => {
//       expect(
//         circle.overlapsRect(new Rect(circle.center, { width: 2, height: 5 }))
//       ).toEqual(true);
//     });
//
...
//     it("should return true if the given circle is inside", () => {
//       expect(circle.overlapsCircle(new Circle(circle.center, 2))).toEqual(true);
//     });
//
//     it("should return false if the given circle is outside", () => {
//       expect(circle.overlapsCircle(new Circle({ x: 20, y: 25 }, 2))).toEqual(
//         false
//       );
//       expect(circle.overlapsCircle(new Circle({ x: -10, y: -10 }, 3))).toEqual(
//         false
//       );
//     });
//
//     it("should return true if the given circle is overlapping", () => {
//       expect(circle.overlapsCircle(new Circle({ x: -2, y: 5 }, 2))).toEqual(
//         true
//       );
//       expect(circle.overlapsCircle(new Circle({ x: -2, y: 2 }, 5))).toEqual(
//         true
//       );
//     });
//
//     it("should return true when given circle is surrounding", () => {
//       expect(circle.overlapsCircle(new Circle(circle.center, 15))).toEqual(
//         true
//       );
//     });
//
...
//       expect(circle.getBoundingRect()).toEqual(
//         new Rect({ x: -1, y: 1 }, { width: 8, height: 8 })
//       );
//     });
//   });
// });
